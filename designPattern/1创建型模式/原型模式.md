...
![img](https://edu.aliyun.com/files/course/2017/09-24/124059b92886760354.jpg)
...
```
import java.util.Hashtable;public class ShapeCache {
...
public class PrototypePatternDemo {
   ...
   nbsp;   System.out.println("Shape : " + clonedShape3.getType());		
   }}
```
